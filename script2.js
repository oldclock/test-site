...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function createVideoCard(video) {
        ...
        let statusText = '';
        if (video.snippet.liveBroadcastContent === 'live') {
            statusText = `<span class="text-red-400 font-bold">● LIVE</span> started at ${new Date(video.liveStreamingDetails.actualStartTime).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit', hour12: false })}`;
